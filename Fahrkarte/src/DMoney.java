...
public class DMoney implements ActionListener{
    JFrame frame;
    JLabel label;
    JTextField field;
    JButton button;
    ...
    DMoney(){
    	...
    	label = new JLabel("Enter money between 5 and 20");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(input > 5 && input <= 20) {
			int changeMoney = input - dprice;
			frame.dispose();
			Pay p = new Pay();
			p.changeField.setText("Change€ : "+ changeMoney + "€");
			...
			//frame.dispose();
			/*Pay p = new Pay();
			p.changeField.setText("Money so big or small");
